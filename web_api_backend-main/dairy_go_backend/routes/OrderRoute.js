...
const { cancelOrder, createOrder, getAllOrders, getOrderById, getOrdersByUserId, confirmOrder, deleteOrder, testOrderRoutes } = require("../controllers/OrderController");
...
router.delete("/:id", deleteOrder); // Delete an order permanently
